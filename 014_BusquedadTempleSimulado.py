"""
Created on 29 march 9:15:32 2024
@author: Jesus Alejandro Montes Aguila 
"""
'''
El código implementa el algoritmo de Temple Simulado para encontrar la mejor
 ruta entre Guadalajara y Puerto Vallarta, utilizando una matriz de distancias 
 entre ciudades. Se generan rutas aleatorias y se aceptan movimientos basados en
 probabilidades, enfriando gradualmente la temperatura para explorar el espacio de
 búsqueda. Finalmente, se imprime la mejor ruta encontrada.
'''
# Importación del módulo numpy como np
import numpy as np

# Matriz de adyacencia que representa las distancias entre las ciudades
distancias = np.array([[0, 2, 3, 0, 5],       # Distancias desde Guadalajara
                       [2, 0, 0, 0, 3],       # Distancias desde Ciudad 1
                       [3, 0, 0, 0, 0],       # Distancias desde Ciudad 2
                       [0, 0, 0, 0, 4],       # Distancias desde Ciudad 3
                       [5, 3, 0, 4, 0]])      # Distancias desde Puerto Vallarta
