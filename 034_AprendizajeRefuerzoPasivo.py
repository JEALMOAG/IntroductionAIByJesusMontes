"""
created on 3 april 22:06:22 2024
@author:Jesus Alejandro Montes Aguila
"""
"""
Este código implementa un Agente de Aprendizaje por Refuerzo Pasivo (APR)
utilizando la regla incremental para actualizar los valores estimados de
las acciones. El agente selecciona acciones basadas en los valores estimados
actuales y recibe una recompensa después de cada acción. Luego, actualiza los
valores estimados utilizando la regla incremental, que ajusta los valores
basándose en la recompensa recibida y la frecuencia con la que se ha
seleccionado la acción. Finalmente, se muestra el resultado de los valores
estimados después de un cierto número de iteraciones.
"""
