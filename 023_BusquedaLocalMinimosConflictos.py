"""
created on april 1 17:48:15 2024
@author: Jesus Alejandro Mntes Aguila
"""
"""
El código implementa un solucionador de problemas de coloración de grafos
utilizando el algoritmo de mínimos conflictos. Este algoritmo asigna colores
a los nodos de un grafo de manera aleatoria y luego resuelve los conflictos
entre nodos vecinos seleccionando un nodo en conflicto y cambiando su color
por uno que minimice los conflictos. El objetivo es encontrar una asignación
de colores para los nodos del grafo donde ningún par de nodos vecinos tengan
el mismo color.
"""
